...
import {TransactionsContext} from '../context/TransactionContext/TransactionsContext';

export default function AddTransaction() {
  const {id} = useParams();
  const {createTransactionAction} = useContext(TransactionsContext);
  ...
  const handleSubmit = e => {
    e.preventDefault();
    createTransactionAction({...formData, account: id});
  };
    ...
    <>
      <div className='flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8'>
        <div className='sm:mx-auto sm:w-full sm:max-w-md'>
          <h2 className='mt-6 text-center text-3xl font-bold tracking-tight text-gray-900'>Add Transaction</h2>
        </div>
        ...
        <div className='mt-8 sm:mx-auto sm:w-full sm:max-w-md'>
          <div className='bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10'>
            <form className='space-y-6' onSubmit={handleSubmit}>
              ...
              <div>
                <label className='block text-sm font-medium text-gray-700'>Transaction Category</label>
                <select
                  name='category'
              ...
              <div>
                <label className='block text-sm font-medium text-gray-700'>Pick Color</label>
                <div className='mt-1'>
                  <input
