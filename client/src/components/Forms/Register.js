        ...
        <div className='container px-4 mx-auto'>
          <div className='max-w-sm mx-auto'>
            <div className='mb-6 text-center'>
              <h3 className='mb-4 text-2xl md:text-3xl font-bold'>Register to create an account</h3>
            </div>
            <form onSubmit={onSubmitHandler}>
              <div className='mb-6'>
                <label className='block mb-2 text-coolGray-800 font-medium' htmlFor>
                  Email
                </label>
                <input
                  value={email}
              ...
              <p className='text-center'>
                ...
                <button className='inline-block text-xs font-medium text-green-500 hover:text-green-600 hover:underline' type='submit'>
